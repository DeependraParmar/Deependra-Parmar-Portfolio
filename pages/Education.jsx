...
const educations = [
  {
    ...
    description: `CSIT from Acropolis Institute of Technology & Research, Indore`,
    score: '8.87 CGPA'
  },
  {
    id: 2,
    ...
    description: `From Ebenezer Senior Secondary School, Dewas, MP affiliated to CBSE Board`,
    score: '95.2%'
  },
  {
    id: 3,
    date: '2018-19',
    title: 'High School Certificate (HSC)',
    description: `From Ebenezer Senior Secondary School, Dewas, MP affiliated to CBSE Board`,
    score: '95.4%'
  }
];
    ...
    >
      <Box>
        ...
        <VStack spacing={2} mb={3} textAlign="left">
          ...
          <Text textAlign={'left'} width={'full'} textDecor={'underline'} color={'gold'} fontWeight={'semibold'}>Scored: {score}</Text>
        </VStack>
      </Box>
    </HStack>
  );
